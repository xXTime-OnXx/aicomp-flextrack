...
# Load data
df_train = pd.read_csv(os.path.normpath(os.path.join(os.path.dirname(__file__), '../data/regression/regression-train.csv')))
df_test = pd.read_csv(os.path.normpath(os.path.join(os.path.dirname(__file__), '../data/regression/regression-test.csv')))
